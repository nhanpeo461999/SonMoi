...
namespace Lipstick_World
{
    public class OnepayCode
    {
        ...
        public static string ReturnURL = "http://soncucdep.somee.com/onepay/vpc_dr"; //"https://localhost:44328/onepay/vpc_dr";//somee: http://soncucdep.somee.com/onepay/vpc_dr;
        /*
